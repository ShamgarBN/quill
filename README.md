...
Phase 0 — Foundation. See [`docs/PRD.md`](docs/PRD.md) for the full plan.

| Phase | Status |
|---|---|
| 0. Foundation | 🚧 in progress |
| 1. Canon ingestion | ⏳ pending |
| 2. LLM provider layer | ⏳ pending |
| 3. Structural engine | ⏳ pending |
| 4. Voice fingerprint | ⏳ pending |
| 5. Drafting modes | ⏳ pending |
...
| Versioning | Local Git auto-commit (gitoxide) | Full history, one-command rollback |
