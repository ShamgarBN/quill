...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::structure_scene_move,
            commands::structure_chapters_list,
            commands::structure_chapter_create,
            commands::structure_chapter_update,
            commands::structure_chapter_delete,
            commands::structure_chapter_reorder,
            ...
            commands::brain_world_list,
            commands::brain_world_create,
            commands::brain_world_update,
            commands::brain_world_delete,
